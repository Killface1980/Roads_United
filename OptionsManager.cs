...
namespace RoadsUnited
{
    public class OptionsManager : MonoBehaviour
    {
        ...
        private void OnSave()
        {
            ...
            RoadsUnitedModLoader.Options = ModOptions.None;
            ...
            if (this.m_allowTrucksCheckBox.isChecked)
            {
                ...
                RoadsUnitedMod.Options |= ModOptions.AllowTrucksInPedestrianRoads;
            }
            if (this.m_allowResidentsCheckBox.isChecked)
            {
                options.allowResidents = true;
                RoadsUnitedMod.Options |= ModOptions.AllowResidentsInPedestrianRoads;
            }
            ...
            */
            ...
            if (this.m_ghostModeCheckBox.isChecked)
            {
                ...
                RoadsUnitedModLoader.Options |= ModOptions.GhostMode;
            }

            try
            {
                XmlSerializer xmlSerializer = new XmlSerializer(typeof(Options));
                using (StreamWriter streamWriter = new StreamWriter(Path.Combine(RoadsUnitedModLoader.modPath, "RoadsUnitedConfig.xml")))
                {
        ...
        public void LoadOptions()
        {
            ...
            {
                XmlSerializer xmlSerializer = new XmlSerializer(typeof(Options));
                using (StreamReader streamReader = new StreamReader(Path.Combine(RoadsUnitedModLoader.modPath, "RoadsUnitedConfig.xml")))
                {
